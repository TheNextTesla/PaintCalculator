...
public abstract class CameraGLRendererBaseImproved implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    protected CameraGLSurfaceViewImproved mView;
    ...
    protected void doStop()
    {
        ...
        CameraGLSurfaceViewImproved.CameraTextureListener listener = mView.getCameraTextureListener();
    ...
    public abstract CameraCharacteristics getCharacteristics();
